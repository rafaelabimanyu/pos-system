<x-app-layout>
    ...
    <div class="mb-6">
        ...
        <p class="text-slate-500 mt-1">Update the details of this product.</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden max-w-3xl">
        <form action="{{ route('products.update', $product) }}" method="POST" class="p-6 md:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-2 border transition duration-150 ease-in-out">{{ old('description', $product->description) }}</textarea>
